...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/baskeball_runner.js");
/******/ })
/************************************************************************/
/******/ ({
...
/*#__PURE__*/
function () {
  function Background(ctx, image, posY, imageLength, speed) {
...
var Obstacle = __webpack_require__(/*! ./obstacle */ "./src/obstacle.js");
...
function (_Obstacle) {
  ...
  function Defender(options) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(Defender).call(this, options));
    _this.sprite = options.sprite;
    _this.defender = new Image();
    _this.defender.src = '../assets/images/defender-img2.png';
    _this.width = 200;
    _this.height = 148;
    return _this;
  }
  ...
  _createClass(Defender, [{
    ...
    value: function draw(ctx) {
      ctx.drawImage(this.defender, 0, 0, this.width, this.height, this.position[0], this.position[1], this.width, this.height);
    }
  }]);
...
var Defender = __webpack_require__(/*! ./defender */ "./src/defender.js");

var Player = __webpack_require__(/*! ./player */ "./src/player.js");

var drawGameOver = __webpack_require__(/*! ./game_over */ "./src/game_over.js");

var Menu = __webpack_require__(/*! ./menu */ "./src/menu.js");
...
function () {
  ...
  _createClass(Game, [{
    ...
    value: function toggleMute() {
      if (this.muteMusic) {
        this.muteMusic = false;
        if (this.gamePlaying) this.backgroundMusic.play();else this.menuMusic.play();
      } else {
        this.muteMusic = true;
    ...
    value: function jump(event) {
      if (event.code === 'Space' && this.gamePlaying) {
        ...
        if (!this.gameOver) this.player.toggleJump();
      }
    }
  }, {
    ...
    value: function createBackground(foregroundCtx) {
...
var Menu = {
  menuButtons: function menuButtons(game) {
    ...
    var playSelectSound = function playSelectSound() {
      selectSound.pause();
...
function () {
  ...
  _createClass(Obstacle, [{
    ...
    value: function draw(ctx) {
      ctx.beginPath();
      ctx.rect(this.position[0], this.position[1], 200, 150); // ctx.fillStyle = 'black';
...
function () {
  ...
  _createClass(Player, [{
    ...
    key: "draw",
    value: function draw(ctx, srcX, srcY) {
      ctx.clearRect(0, 0, 800, 400);
      ctx.drawImage(this.character, srcX, srcY, this.width, this.height, this.position[0], this.position[1], this.width, this.height);
    }
  }, {
    key: "update",
    ...
    key: "collidedWith",
    value: function collidedWith(obstacle) {
      var playerHitbox = this.hitbox();
      var obstacleHitbox = obstacle.hitbox();
      return !(playerHitbox.maxX < obstacleHitbox.minX || playerHitbox.minX > obstacleHitbox.maxX || playerHitbox.maxY < obstacleHitbox.minY || playerHitbox.minY > obstacleHitbox.maxY);
    }
  }, {
    key: "hitbox",
    value: function hitbox() {
